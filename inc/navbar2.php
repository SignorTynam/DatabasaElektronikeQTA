...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top shadow-sm">
  <div class="container-fluid px-3 px-md-4">
    <a class="navbar-brand d-flex align-items-center gap-2" href="/agency_dashboard.php" title="QTA">
      <!-- Nëse ke logo: <img src="/assets/logo.svg" alt="QTA"> -->
      <i class="bi bi-grid-1x2-fill"></i>
      <span>QTA • Agjenci</span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navAgency">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item"><a class="nav-link <?= $active('dashboard') ?>" href="/agency_dashboard.php"><i class="bi bi-speedometer2 me-1"></i>Dashboard</a></li>
